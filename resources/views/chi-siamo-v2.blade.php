...
@section('title', app()->getLocale() === 'it' ? 'Chi Siamo — TONINOcè' : 'About Us — TONINOcè')

@section('description', app()->getLocale() === 'it'
    ? 'Scopri la storia e il metodo di TONINOcè, studio di ingegneria strutturale fondato nel 1998. Precisione, sostenibilità e visione in ogni progetto.'
    : 'Discover the story and method of TONINOcè, structural engineering studio founded in 1998. Precision, sustainability and vision in every project.')
